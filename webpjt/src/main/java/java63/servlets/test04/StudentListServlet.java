...
public class StudentListServlet extends GenericServlet {
  ...
  public void service(ServletRequest request, ServletResponse response)
    ...
    out.println("<p><a href='student-form.html' class='btn btn-primary'>학생 등록</a></p>");
    out.println("<table class='table table-hover'>");
    out.println("<tr>");
    out.println("  <th>#</th><th>학생명</th><th>나이</th><th>전화번호</th><th>이메일</th><th>성별</th><th>과목</th>");
    out.println("</tr>");
    ...
    for (Student student : studentDao.selectList(pageNo, pageSize)) {
      ...
      out.println("  <td><a href='view?no=" + student.getNo() + "'>" 
