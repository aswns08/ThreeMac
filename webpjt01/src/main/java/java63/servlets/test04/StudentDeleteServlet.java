...
@WebServlet("/test04/student/delete")
public class StudentDeleteServlet extends GenericServlet {
  ...
  public void service(ServletRequest request, ServletResponse response)
    ...
    //AppInitServlet.studentDao.delete(no);
    //ContextLoaderListener.studentDao.delete(no);
...
Location: http://192.168.0.32:8080/web02t/test02/student/list
